...
import mobileProblemBanner from '../../assets/banners/Mobile banner authentiks/Problem.png';
            ...
            <section className="relative pt-8 md:pt-12 px-4 md:px-6 md:min-h-[85vh] flex items-center overflow-hidden">
                ...
                <div className="container mx-auto text-center relative z-10 ">
                    ...
                    <div
                        ...
                        className="hidden md:block hero-slide-enter relative w-[88%] mx-auto mb-10 rounded-[2rem] overflow-hidden shadow-2xl shadow-red-500/20 border border-white/5 cursor-pointer group"
                    >
                    ...
                    <div className="block md:hidden hero-slide-enter relative w-[94%] mx-auto mb-8">
                        <div className="relative w-full rounded-2xl overflow-hidden shadow-xl border border-white/10 mb-5">
                            <img 
                                src={mobileProblemBanner} 
                                alt="Problem Page banner" 
