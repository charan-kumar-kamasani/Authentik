            ...
            <section className="py-20 md:py-32 px-6">
                <div className="container mx-auto max-w-4xl">
                    ...
                    <div className="prose  prose-lg max-w-none prose-headings:font-black prose-headings:uppercase prose-headings:tracking-tight prose-p:font-medium prose-p:text-slate-600 prose-ul:font-medium prose-ul:text-slate-600">
                        ...
                        <h3 className="text-xl font-black text-slate-900 mt-8 mb-4">A. Information You Provide (Brands / Businesses)</h3>
                        ...
                        <h3 className="text-xl font-black text-slate-900 mt-8 mb-4">B. Information Collected via QR Code Scans (End Users)</h3>
                        ...
                        <h3 className="text-xl font-black text-slate-900 mt-8 mb-4">C. Automatically Collected Data</h3>
                        ...
                        <div className="bg-emerald-50 border-l-4 border-emerald-500 p-4 my-6 text-emerald-700 font-bold italic">
                        ...
                        <p className="italic text-slate-600">All partners are required to maintain confidentiality and data security.</p>
                        ...
                        <p className="italic text-slate-600">While we strive to protect your data, no system is 100% secure.</p>
                        ...
                        <p className="italic text-slate-600">To exercise these rights, contact us at the email below.</p>
                        ...
                        <div className="mt-20 glass-effect p-10 rounded-[2.5rem] border border-white/5 text-center">
                            ...
                            <p className="text-slate-600 font-bold mb-8 text-lg">At Authentiks, protecting your data is as important as protecting your products.</p>
                            
                            <div className="p-6 bg-white/5 border border-slate-200 rounded-2xl max-w-2xl mx-auto">
                                <h4 className="text-sm font-black text-indigo-400 uppercase tracking-widest mb-2">Founder Note</h4>
                                <p className="text-slate-900 font-bold italic">“We are building Authentiks on a foundation of trust — not just for products, but for data and relationships as well.”</p>
                            </div>
                        </div>
