            ...
            <section className="py-24 px-6 relative">
                ...
                <div className="container mx-auto max-w-5xl">
                    <div className="glass-effect p-10 md:p-16 rounded-[3rem] border border-white/5 flex flex-col md:flex-row gap-12 items-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex-grow border-l-0 md:border-l border-white/10 md:pl-12">
                            <h4 className="text-xl font-black text-white uppercase tracking-tight mb-6">Led by Experience Across Operations, Growth & Scale</h4>
                            <div className="space-y-4 text-gray-400 font-bold text-sm leading-relaxed mb-6 whitespace-pre-line">
                                <p>Authentiks is founded by Ibadul Hassan, a seasoned business leader with over 16+ years of experience across operations, supply chain, and business growth.</p>
                                <p>His journey has been built on solving real-world execution challenges — working at the intersection of products, services, and scale.</p>
                                <p className="text-white mt-4">Worked with leading organizations such as:</p>
                                <div className="flex flex-wrap gap-3 mt-2">
                                    {['Urban Company', 'Decathlon', 'Tata Consultancy Services', 'Gaia Ji'].map(t => (
                                        <span key={t} className="px-3 py-1 rounded bg-white/5 border border-white/10 text-gray-300 text-xs font-black uppercase tracking-wider">{t}</span>
                                    ))}
                                </div>
                                <ul className="list-disc pl-5 mt-4 space-y-1 text-gray-400">
                                    <li>Launched and scaled city operations</li>
                                    <li>Built and managed large teams</li>
                                    <li>Optimized supply chains and quality systems</li>
                                    <li>Led business expansion and growth initiatives</li>
                                </ul>
                            </div>
                            <div className="pt-6 border-t border-white/5 text-indigo-400 font-black italic flex items-center gap-2">
                                <ArrowRight size={18} /> Built by someone who understands real-world execution — not just software.
                            </div>
                        </div>
